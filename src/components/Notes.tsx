      ...
      <div className="divide-y divide-stone-100 dark:divide-stone-800">
        ...
        <Item title="各カードの上限">
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>メルカード：メルカリでの還元は月5,000ポイントまで。計算は設定した利用月数に均等に使う前提です（1か月に集中して払うと、その月は5,000ポイントで頭打ちになります）。メルカリ以外は通常1%（一部対象外の加盟店あり）。</li>
        ...
        <Item title="マイルと無料宿泊の「円相当」の読み方">
          <p>表示額は現金で受け取れる金額ではありません。マイルや宿泊を設定した単価で使い切った場合の比較値です。旅行の予定が少ない場合は、1マイルの価値や無料宿泊の価値を下げ、現金ポイントとも比較してください。</p>
          <p>特典航空券には空席・有効期限・税金や手数料の条件があります。無料宿泊はカードの継続と対象決済額の達成が必要で、利用できるホテル・日程にも条件があります。入会キャンペーンや家族カードの費用は計算に含めません。</p>
        </Item>
        <Item title="申し込み前に">
    ...
    <footer className="mt-8 space-y-4 border-t border-stone-200 pt-6 text-xs leading-relaxed text-stone-600 dark:border-stone-800 dark:text-stone-400">
      <div>
        ...
        <ul className="mt-1 list-disc pl-5">
          ...
          <li>メルカードのメルカリ還元率 {Math.round(a.mercardRate * 100)}%（年{a.mercariMonths}か月に均等に利用）、Airカードの利用枠（総枠）{a.airLimit / 10_000}万円</li>
